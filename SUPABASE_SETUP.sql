...
-- Migrate images to JSONB (idempotent)
ALTER TABLE laptops
...
VALUES
  ...
  jsonb_build_array('https://images.unsplash.com/photo-1544731612-de7f96afe55f?w=800&q=80'),
   '{"i5-1135G7","8GB RAM","256GB SSD","Backlit"}','{}'),
  ('HP','HP 250 G7','i5-1035G1','8GB','256GB SSD','Intel UHD 620','15.6"','Good',60000,1,
  jsonb_build_array('https://images.unsplash.com/photo-1589561084283-930aa7b1ce50?w=800&q=80'),
   '{"i5-1035G1","8GB RAM","256GB SSD","15.6\" Display"}','{}'),
  ('HP','EliteBook 1040 G4','i7-7500U','8GB','256GB SSD','Intel UHD 620','14"','Fair',60000,1,
  jsonb_build_array('https://images.unsplash.com/photo-1618424181497-157f25b6ddd5?w=800&q=80'),
   '{"i7-7500U","8GB RAM","256GB SSD","Backlit"}','{}'),
  ('HP','EliteBook 1030 G4 x360','i5-8265U','8GB','256GB SSD','Intel UHD 620','13.3"','Fair',62000,1,
  jsonb_build_array('https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80'),
   '{"i5-8265U","8GB RAM","256GB SSD","2-in-1"}','{}'),
  ('HP','EliteBook 840 G5','i5-8250U','8GB','256GB SSD','Intel UHD 620','14"','Good',54000,1,
  jsonb_build_array('https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?w=800&q=80'),
   '{"i5-8250U","8GB RAM","256GB SSD","Backlit"}','{}'),
  ('HP','Spectre x360','i5-6200U','8GB','256GB SSD','Intel HD 520','13.3"','Good',40000,1,
  jsonb_build_array('https://images.unsplash.com/photo-1504707748692-419802cf939d?w=800&q=80'),
   '{"i5-6200U","8GB RAM","256GB SSD","2-in-1"}','{}'),
  ('HP','HP 250 G4','i5-6200U','8GB','256GB SSD','Intel HD 520','15.6"','Fair',25000,1,
  jsonb_build_array('https://images.unsplash.com/photo-1516387938699-a93567ec168e?w=800&q=80'),
   '{"i5-6200U","8GB RAM","256GB SSD","15.6\" Display"}','{}'),
...
VALUES
  ...
  jsonb_build_array('https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=800&q=80'),
